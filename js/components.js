...
function inicializarMundiales() {
    ...
    const mundiales = [
      { year: 2022, name: "Qatar 2022", file:"2022qatar.html" },
      { year: 2018, name: "Rusia 2018", file:"2018rusia.html" },
      { year: 2014, name: "Brasil 2014", file:"2014brasil.html" },
      { year: 2010, name: "Sudáfrica 2010", file:"2010southafrica.html" },
      { year: 2006, name: "Alemania 2006", file:"2006germany.html" },
      { year: 2002, name: "Corea-Japón 2002", file:"2002koreajapan.html" },
      { year: 1998, name: "Francia 1998", file:"1998france.html" },
      { year: 1994, name: "Estados Unidos 1994", file:"1994usa.html" },
      { year: 1990, name: "Italia 1990", file:"1990italy.html" },
      { year: 1986, name: "México 1986", file:"1986mexico.html" },
      { year: 1982, name: "España 1982", file:"1982spain.html" },
      { year: 1978, name: "Argentina 1978", file:"1978argentina.html" },
      { year: 1974, name: "Alemania 1974", file:"1974germany.html" },
      { year: 1970, name: "México 1970", file:"1970mexico.html" },
      { year: 1966, name: "Inglaterra 1966", file:"1966england.html" },
      { year: 1962, name: "Chile 1962", file:"1962chile.html" },
      { year: 1958, name: "Suecia 1958", file:"1958sweden.html" },
      { year: 1954, name: "Suiza 1954", file:"1954switzerland.html" },
      { year: 1950, name: "Brasil 1950", file:"1950brasil.html" },
      { year: 1938, name: "Francia 1938", file:"1938france.html" },
      { year: 1934, name: "Italia 1934", file:"1934italy.html" },
      { year: 1930, name: "Uruguay 1930", file:"1930uruguay.html" }
    ];

    const MUNDIALES_POR_PAGINA = 5;
    let indiceActual = 0;

    const lista = document.getElementById("mundiales-list");
    const btnCargar = document.getElementById("load-more-mundiales");

    if (!lista || !btnCargar) {
        console.warn("Sidebar aún no existe");
        return;
    }

    function cargarMundiales() {
        const fin = indiceActual + MUNDIALES_POR_PAGINA;
        const lote = mundiales.slice(indiceActual, fin);

        lote.forEach(m => {
            const li = document.createElement("li");
            li.innerHTML = `
                <a href="${m.file}" class="sidebar-link">
                    <img src="Images/Icons/globe.svg" class="icon" alt="Mundo">
                    <div class="sidebar-section-item-details">${m.name}</div>
                </a>
            `;
        ...
        indiceActual = fin;
        if (indiceActual >= mundiales.length) {
            btnCargar.style.display = "none";
        }
    }

    cargarMundiales();
    btnCargar.addEventListener("click", cargarMundiales);
}
